...
namespace Marlin.View.Chrome
{
    public class TopMenu : Gtk.HeaderBar {
        ...
        public TopMenu (Marlin.View.Window window) {
            ...
            button_back = new Marlin.View.Chrome.ButtonWithMenu.from_icon_name ("go-previous-symbolic", Gtk.IconSize.MENU);
            button_forward = new Marlin.View.Chrome.ButtonWithMenu.from_icon_name ("go-next-symbolic", Gtk.IconSize.MENU);
